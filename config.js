...
global.THUMB_IMAGE = process.env.THUMB_IMAGE || process.env.IMAGE || "https://telegra.ph/file/6565c189217537ef34164.jpg";
...
module.exports = {
  ...
  author: process.env.PACK_AUTHER || "RICHY-MD",
  packname: process.env.PACK_NAME || "R I C H Y",
  botname: process.env.BOT_NAME || "RICHY-MD",
  ownername: process.env.OWNER_NAME || "GEEK",
  errorChat: process.env.ERROR_CHAT || "",
  KOYEB_API: process.env.KOYEB_API || "false",
  REMOVE_BG_KEY: process.env.REMOVE_BG_KEY || "",
  OPENAI_API_KEY: process.env.OPENAI_API_KEY || "sk-proj-byew4WCBYZISkE7ILvhhT3BlbkFJkxEn4uvkgJN3QrMRtwe6",
  ...
  LANG: (process.env.THEME || "RICHY").toUpperCase(),
};
global.rank = "updated";
